...
def result(request) :
    ...
    dict1 = {'prod':[prod[crop_name]],'Day':[day],'Month':[month],'Year':[year]}
    ...
    for i in range(0,6) :
        if (month != 12) :
            dict2 = {'prod':[prod[crop_name]],'Day':[day],'Month':[month+i],'Year':[year]}
        else :
            month = 1
            dict2 = {'prod':[prod[crop_name]],'Day':[day],'Month':[month],'Year':[year+1]}
    ...
    for i in range(0,6) :
        if (month != 12) :
            dict3 = {'prod':[prod[crop_name]],'Day':[day],'Month':[month+i],'Year':[year]}
        else :
            month = 1
            dict3 = {'prod':[prod[crop_name]],'Day':[day],'Month':[month],'Year':[year+1]}
